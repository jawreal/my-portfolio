       ...
       <motion.div
         ...
         <div className="rounded-md relative w-[calc(100%-2rem)] mx-auto md:w-72 md:h-72 z-10">
           <Suspense fallback={<Skeleton className="w-full h-full" />}>
             <Image url="https://res.cloudinary.com/dfr6tbwcf/image/upload/v1780466584/me2_ez7wl5.jpg" className="w-full h-72 object-cover border border-slate-500 dark:border-slate-700" />
           </Suspense>
